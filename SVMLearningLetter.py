...
class SVMLearnerLetter():
    ...
    def generateFinalAccuracy(self, prefix=''):
        ...
        filename = '{}/images/{}/{}/{}_{}_CM_Normalized_{}.png'.format('.', self.datasetName, self.algoname, self.datasetName, self.algoname, prefix)
    ...
    def doGridSearch(self):
        parameters = {"C": np.arange(0.001, 2.5, 0.25), "gamma":np.arange(1 / self.features.shape[1], 2.1, 0.2)}

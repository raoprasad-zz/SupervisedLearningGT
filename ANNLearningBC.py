...
class annLearnerBC():
    ...
    def learn(self):
        ...
        self.classifier = mlpc(max_iter=3000, early_stopping=True)
        ...
        self.plot_validation_curve(self.classifier,X_train,y_train,"alpha", [10 ** -x for x in np.arange(-1, 9.01, 0.5)], cv=cv)
